...
def build_reverse_graph(graph):
    ...
    for package in graph:
        for dep in graph[package]:
            ...
            reverse_graph[dep_name].append(package)
    return reverse_graph

def print_graph(graph, reverse_graph):
    ...
    for package, reverse_deps in reverse_graph.items():
...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print_graph(graph, reverse_graph)
